...
class OpenItemsReportCompute(models.TransientModel):
    ...
    def _recalculate_move_lines(self, move_lines, debit_ids, credit_ids,
        ...
        ml_fields = [
            ...
            'amount_residual_currency', "analytic_account_id","operating_unit_id"]
    ...
    def _insert_line_info(self, line_data):
        ...
        operating_unit_id = line_data.get('operating_unit_id', 0)
        if operating_unit_id:
            operating_unit_id = operating_unit_id[0]
        analytic_account_id = line_data.get('analytic_account_id', 0)
        ...
        if analytic_account_id:
            ...
            analytic = self.env['account.analytic.account'].browse(analytic_account_id)
            complete_wbs_code = analytic.complete_wbs_code
        else:
            complete_wbs_code = "Undefined"
        insert_query = """
        ...
        """ % (
            ...
            amount_total_due,
            amount_residual,
            operating_unit_id or "null",
            analytic_account_id or "null",
            currency_id or "null",
            amount_total_due_currency,
            amount_residual_currency,
            complete_wbs_code
