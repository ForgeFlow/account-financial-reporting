...
class OutstandingStatementXslx(models.AbstractModel):
    ...
    def _write_currency_lines(self, row_pos, sheet, partner, currency, data):
        ...
        sheet.write(row_pos, 2, _("Due Date"), self.format_theader_blue_center)
        sheet.write(row_pos, 3, _("Description"), self.format_theader_blue_center)
        sheet.write(row_pos, 4, _("Original"), self.format_theader_blue_center)
